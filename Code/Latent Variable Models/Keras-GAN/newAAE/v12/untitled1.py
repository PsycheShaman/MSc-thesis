...
if __name__ == '__main__':
    ...
    aae.train(epochs=400001, batch_size=32, sample_interval=10)
    aae.save_model()
    
test = aae.decoder.predict(np.random.normal(0, 1, (1000000, aae.latent_dim)))

np.save("C:/Users/gerhard/Documents/Keras-GAN/newAAE/v12/simulated_data/sim.npy",test)

test = aae.decoder.predict(np.random.normal(0, 1, (5000000, aae.latent_dim)))

np.save("C:/Users/gerhard/Documents/Keras-GAN/newAAE/v12/simulated_data/sim_big.npy",test)
