...
rm(list=ls())
require(stringr)
for(model in c("xgb0_results","xgb1_results","xgb2_results")){
  print("--------------------------------------------------------------------------------------------------")
  print(model)
  print("--------------------------------------------------------------------------------------------------")

pred <- read.csv(paste0("C:/Users/gerhard/Documents/hpc-mini/xgb/",model,".csv"),header=F,sep = "")
act <- read.csv(paste0("C:/Users/gerhard/Documents/hpc-mini/xgb/", 
                       str_replace(model,regex("_.+"),"") ,
...
rm(list=ls())
require(stringr)
for(model in c("merging1_results")){
  print("--------------------------------------------------------------------------------------------------")
  print(model)
  print("--------------------------------------------------------------------------------------------------")

pred <- read.csv(paste0("C:/Users/gerhard/Documents/MSc-thesis/NEW/ML/",model,".csv"),header=F,sep = "")
act <- read.csv(paste0("C:/Users/gerhard/Documents/MSc-thesis/NEW/ML/", 
                       str_replace(model,regex("_.+"),"") ,
