...
plt.savefig('/home/vljchr004/hpc-mini/chamber_gain_corrected/model12_history1.png', bbox_inches='tight')
plt.close()
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('/home/vljchr004/hpc-mini/chamber_gain_corrected/model12_history2.png', bbox_inches='tight')
...
import numpy as np
np.savetxt("/home/vljchr004/hpc-mini/chamber_gain_corrected/model12_results.csv", np.array(model.probs), fmt="%s")

np.savetxt("/home/vljchr004/hpc-mini/chamber_gain_corrected/model12_y_test.csv", np.array(y_test), fmt="%s")

model.save('/home/vljchr004/hpc-mini/chamber_gain_corrected/model12_.h5')  # creates a HDF5 file 'my_model.h5'
del model
