...
def smooth_positive_labels(y):
	return y - 0.15 + (np.random.random(y.shape) * 0.5)
...
if __name__ == '__main__':
    gan = GAN()
    gan.train(epochs=30000000000000000000000000000000000000000000000000000001, batch_size=32, sample_interval=100)