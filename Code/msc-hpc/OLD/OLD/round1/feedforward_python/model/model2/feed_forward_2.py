...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('/home/vljchr004/msc-hpc/feedforward_python/fig/feed_forward_2_history2.png', bbox_inches='tight')
...
model1.save('/home/vljchr004/msc-hpc/feedforward_python/feed_forward_2.h5')  # creates a HDF5 file 'my_model.h5'
del model1
...
#plt.xlabel('epoch')
#plt.legend(['train', 'test'], loc='upper left')
#plt.savefig('/home/vljchr004/msc-hpc/feedforward_python/fig/feed_forward_2_history.png', bbox_inches='tight')
#
#model1.probs = model1.predict_proba(x_test)
#
#import numpy as np
