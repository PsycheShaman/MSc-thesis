...
model = Sequential()
model.add(LSTM(500,input_shape=(24,17),return_sequences=False))
model.add(Dense(500,activation="relu"))
model.add(Dense(2,activation="softmax"))

sgd = tensorflow.keras.optimizers.SGD(momentum=0.9,lr=0.00001,nesterov=True) 
...
plt.savefig('/home/vljchr004/hpc-mini/model31_history1.png', bbox_inches='tight')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('/home/vljchr004/hpc-mini/model31_history2.png', bbox_inches='tight')

model.probs = model.predict_proba(x_test)

import numpy as np
np.savetxt("/home/vljchr004/hpc-mini/model31_results.csv", np.array(model.probs), fmt="%s")

np.savetxt("/home/vljchr004/hpc-mini/model31_y_test.csv", np.array(y_test), fmt="%s")

model.save('/home/vljchr004/hpc-mini/model31_.h5')  # creates a HDF5 file 'my_model.h5'
del model
