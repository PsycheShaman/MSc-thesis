...
```{r}
rm(list=ls())
for(model in c("C:/Users/gerhard/Documents/MSc-thesis/NEW/ML/ensemble1_out.csv","C:/Users/gerhard/Documents/MSc-thesis/NEW/ML/ensemble2_out.csv")){
  print("--------------------------------------------------------------------------------------------------")
  print(model)
  print("--------------------------------------------------------------------------------------------------")

pred <- read.csv(model,header=F)
...
```{r}
mse <- (pred_act$six_tracklet_pred-pred_act$six_tracklet_real)^2
