...
if ! [ -f DigitsExtractQA.root ] ; then
   error=1
   echo "Output file DigitsExtractQA.root not found. Job FAILED !" >> stdout
   echo "Output file DigitsExtractQA.root not found. Job FAILED !" >> stderr
fi
