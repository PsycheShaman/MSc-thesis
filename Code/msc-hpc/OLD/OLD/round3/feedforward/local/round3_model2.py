...
plt.savefig('C:/Users/gerhard/Documents/msc-hpc/round3/feedforward/local/round3_model2_history1.png', bbox_inches='tight')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('C:/Users/gerhard/Documents/msc-hpc/round3/feedforward/local/round3_model2_history2.png', bbox_inches='tight')

model1_dropout_0_5.probs = model1_dropout_0_5.predict_proba(x_test)

import numpy as np
np.savetxt("C:/Users/gerhard/Documents/msc-hpc/round3/feedforward/local/round3_model2_results.csv", np.array(model1_dropout_0_5.probs), fmt="%s")

np.savetxt("C:/Users/gerhard/Documents/msc-hpc/round3/feedforward/local/round3_model2_y_test.csv", np.array(y_test), fmt="%s")

model1_dropout_0_5.save('C:/Users/gerhard/Documents/msc-hpc/round3/feedforward/local/round3_model2_.h5')  # creates a HDF5 file 'my_model.h5'
