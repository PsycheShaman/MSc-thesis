...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('/home/vljchr004/msc-hpc/feedforward_python/fig/feed_forward_3_history2.png', bbox_inches='tight')
...
np.savetxt("/home/vljchr004/msc-hpc/feedforward_python/results/feed_forward_3_y_test.csv", np.array(y_test), fmt="%s")

model1.save('/home/vljchr004/msc-hpc/feedforward_python/feed_forward_3.h5')  # creates a HDF5 file 'my_model.h5'
del model1
