...
plt.savefig('/home/vljchr004/hpc-mini/final/model25_1_5_history1.png', bbox_inches='tight')
plt.close()
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('/home/vljchr004/hpc-mini/final/model25_1_5_history2.png', bbox_inches='tight')
...
import numpy as np
np.savetxt("/home/vljchr004/hpc-mini/final/model25_1_5_results.csv", np.array(model.probs), fmt="%s")

np.savetxt("/home/vljchr004/hpc-mini/final/model25_1_5_y_test.csv", np.array(y_test), fmt="%s")
print("saving model")
model.save('/home/vljchr004/hpc-mini/final/model25_1_5.h5')  # creates a HDF5 file 'my_model.h5'
print("model saved")
