...
ggplot(bethe_bloch,aes(y=dEdX,x=P))+geom_hex(bins=1000)+facet_wrap(~y)+xlab("Momentum (GeV/c)")+ylab("dE/dX (Arbitrary Units)")

+ stat_summary(aes(group=y), fun.y=mean, geom="line", colour="orange")
