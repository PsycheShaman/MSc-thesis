...
import numpy as np
np.savetxt("C:/Users/Gerhard/Documents/hpc-mini/xgb/xgb0_results.csv", np.array(model.probs), fmt="%s")

np.savetxt("C:/Users/Gerhard/Documents/hpc-mini/xgb/xgb0_y_test.csv", np.array(y_test), fmt="%s")
