...
def adam_optimizer():
    return tf.keras.optimizers.SGD(lr=0.00001,momentum=0.99)
...
def create_discriminator():
    ...
    discriminator.add(tf.keras.layers.Dense(6,activation="relu"))
...
def plot_generated_images(epoch, generator, examples=1, dim=(10,10), figsize=(17,24)):
    ...
    for i in range(generated_images.shape[0]):
        ...
        plt.axis('off')
        plt.tight_layout()
        plt.savefig('gan20_generated_image %d.png' %epoch)
