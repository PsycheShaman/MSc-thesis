...
for i in range(1000000):
    ...
    if not i % 200:
        ...
        plt.savefig('C:\\Users\\gerhard\\Documents\\deep-gen/vae11_train'+str(i)+'_real'+'.png', bbox_inches='tight')
        plt.show()
        plt.imshow(d[0], cmap='gray')
        
        plt.savefig('C:\\Users\\gerhard\\Documents\\deep-gen/vae11_train'+str(i)+'_gen'+'.png', bbox_inches='tight')
        plt.show()
...
for img in imgs:
    ...
    plt.savefig('C:/Users/Gerhard/Documents/deep-gen/vae11_res'+str(i)+'.png', bbox_inches='tight')
