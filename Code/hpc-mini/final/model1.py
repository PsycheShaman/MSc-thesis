...
plt.savefig('/home/vljchr004/hpc-mini/final/model1_history1.png', bbox_inches='tight')
plt.close()
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('/home/vljchr004/hpc-mini/final/model1_history2.png', bbox_inches='tight')
...
import numpy as np
np.savetxt("/home/vljchr004/hpc-mini/final/model1_results.csv", np.array(model.probs), fmt="%s")

np.savetxt("/home/vljchr004/hpc-mini/final/model1_y_test.csv", np.array(y_test), fmt="%s")

model.save('/home/vljchr004/hpc-mini/final/model1_.h5')
del model
