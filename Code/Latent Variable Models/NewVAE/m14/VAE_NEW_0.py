...
for j in range(46,5000000000000000000000000000000000000000000000000000000):
    print("macro_epoch_batch_"+str(j))
    vae.fit(x_train[np.random.randint(low=0,high=x_train.shape[0],size=100000),:],
                epochs=1,
                batch_size=batch_size)
...
for j in range(55,5000000000000000000000000000000000000000000000000000000):
    print("macro_epoch_batch_"+str(j))
    vae.fit(x_train[np.random.randint(low=0,high=x_train.shape[0],size=100000),:],
                epochs=1,
                batch_size=batch_size)
...
for j in range(63,5000000000000000000000000000000000000000000000000000000):
    print("macro_epoch_batch_"+str(j))
    vae.fit(x_train[np.random.randint(low=0,high=x_train.shape[0],size=100000),:],
                epochs=1,
                batch_size=batch_size)
...
def load_data():
        ...
        with open(x_files[9],'rb') as x_file:
            x = pickle.load(x_file)
...
for j in range(70,5000000000000000000000000000000000000000000000000000000):
    print("macro_epoch_batch_"+str(j))
    vae.fit(x_train[np.random.randint(low=0,high=x_train.shape[0],size=500000),:],
                epochs=1,
                batch_size=batch_size)
#        ,
#                validation_data=(x_test, None))
...
for j in range(76,5000000000000000000000000000000000000000000000000000000):
    print("macro_epoch_batch_"+str(j))
...
for j in range(100,5000000000000000000000000000000000000000000000000000000):
    print("macro_epoch_batch_"+str(j))
    vae.fit(x_train[np.random.randint(low=0,high=x_train.shape[0],size=5000),:],
                epochs=10,
                batch_size=batch_size)
...
for j in range(106,5000000000000000000000000000000000000000000000000000000):
    print("macro_epoch_batch_"+str(j))
    vae.fit(x_train,#[np.random.randint(low=0,high=x_train.shape[0],size=5000),:],
                epochs=1,
                batch_size=batch_size)
