...
void runAnalysis()
{
    ...
    //gSystem->Load("lidGeom.so");	// *
    //gSystem->Load("libVMC.so");		// *
   // gSystem->Load("libSTEERBase.so");	// *
   // gSystem->Load("libESD.so");		// *
    //gSystem->Load("livAOD.so");		// *
    ...
    if(local) {
        ...
        alienHandler->SetAliPhysicsVersion("vAN-20180820-1");
        // set the Alien API version
        alienHandler->SetAPIVersion("V1.1x");
        // select the input data
        alienHandler->SetGridDataDir("/alice/data/2016/LHC16s");
        alienHandler->SetDataPattern("pass1_CENT_woSDD/16000267110039.804/AliESDs.root");
