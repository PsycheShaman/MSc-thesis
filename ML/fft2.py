...
plt.savefig('C:/Users/gerhard/documents/MSc-thesis/fft2_history1.png', bbox_inches='tight')
plt.close()
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('C:/Users/gerhard/documents/MSc-thesis/fft2_history2.png', bbox_inches='tight')
