...
#    generator.add(LeakyReLU())
    ...
    generator.add(Dense(units=1024,activation=tf.nn.leaky_relu))
#    generator.add(LeakyReLU())
    
    generator.add(Dense(units=2048,activation='sigmoid'))
...
def plot_generated_images(epoch, generator, examples=100, dim=(10,10), figsize=(10,10)):
    ...
    generated_images = generated_images.reshape(100,17,24)
    ...
    for i in range(generated_images.shape[0]):
        ...
        plt.axis('off')
    plt.tight_layout()
    plt.savefig('gan2_generated_image %d.png' %epoch)
