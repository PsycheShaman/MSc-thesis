...
for i in range(1000000):
    ...
    if stop>x_train.shape[0]:
        break
    batch=x[start:stop,:]
    batch=np.reshape(batch,[10,17,24])
    start=stop
    stop=start+10
    ...
    if not i % 200:
        ...
        plt.savefig('C:\\Users\\gerhard\\Documents\\deep-gen/vae10_train'+str(i)+'_real'+'.png', bbox_inches='tight')
        plt.show()
        plt.imshow(d[0], cmap='gray')
        
        plt.savefig('C:\\Users\\gerhard\\Documents\\deep-gen/vae10_train'+str(i)+'_gen'+'.png', bbox_inches='tight')
        plt.show()
