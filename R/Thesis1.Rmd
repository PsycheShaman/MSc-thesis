---
title: "Thesis Draft One"
author: "Gerhard Viljoen - VLJCHR004"
...
* 2 hidden layers of 200 neurons each
* 100 epochs
...
* One hidden layer of 500 neurons
* 100 epochs
* 10-fold cross validation
...
Build yet another differenct architecture:
...
#Tuning:
The above information suggests fewer hidden layers, with more neurons is more suited to this problem.

We build a fourth neural network architecture:
* 2 hidden layers of 500 neurons each
* 200 epochs

And test this with various activation functions:
...
#Recitfier with Dropout with 2 additional hidden layers of 500 neurons each:
...
Add the predictions from all 7 neural networks as features to dataset:
...
Predict using randomforests, and add its prediction as a feature:
...
Perform k-means clustering, with k=10, and add cluster group as a variable:
...
Predict using various kernels and add as features:
...
Build a random forest that uses all the new features, as well as the original dataset to classify particles as pdgcode 211 or pdgcode -211:
