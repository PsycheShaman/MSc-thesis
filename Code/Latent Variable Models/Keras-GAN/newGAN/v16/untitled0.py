...
def smooth_positive_labels(y):
	return y - 0.29 + (np.random.random(y.shape) * 0.5)

def smooth_negative_labels(y):
	return y + np.random.random(y.shape) * 0.29
...
#noise = np.random.normal(0, 1, (1000000, gan.latent_dim))
#
#gen_imgs = gan.generator.predict(noise)
#
#np.save("simulated_data/1million_after100000epochs"+".npy",arr=gen_imgs)
...
np.save("simulated_data/1million_after200000epochs"+".npy",arr=gen_imgs)
