...
model = Sequential()
model.add(Conv2D(16, (2, 2), padding='valid',input_shape=(17,24,1),data_format="channels_last"))
...
plt.savefig('C:/Users/gerhard/Documents/msc-hpc/round3/conv/round3_model1_history1.png', bbox_inches='tight')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('C:/Users/gerhard/Documents/msc-hpc/round3/conv/round3_model1_history2.png', bbox_inches='tight')

model.probs = model.predict_proba(x_test)

import numpy as np
np.savetxt("C:/Users/gerhard/Documents/msc-hpc/round3/conv/round3_model1_results.csv", np.array(model.probs), fmt="%s")

np.savetxt("C:/Users/gerhard/Documents/msc-hpc/round3/conv/round3_model1_y_test.csv", np.array(y_test), fmt="%s")

model.save('C:/Users/gerhard/Documents/msc-hpc/round3/conv/round3_model1_.h5')  # creates a HDF5 file 'my_model.h5'
del model
