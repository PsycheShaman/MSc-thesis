...
np.savetxt("C:/Users/Gerhard/Documents/MSc-thesis/NEW/ML/merging2_results.csv", np.array(model.probs), fmt="%s")

np.savetxt("C:/Users/Gerhard/Documents/MSc-thesis/NEW/ML/merging2_y_test.csv", np.array(y_test), fmt="%s")
