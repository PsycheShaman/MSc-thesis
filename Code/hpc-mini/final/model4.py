...
model.add(tf.keras.layers.Conv2D(filters=16,kernel_size=(8,12),strides=1, padding='valid',activation="relu",name="16filters8x2",input_shape=(17,24,1)))
...
plt.savefig('/home/vljchr004/hpc-mini/final/model4_history1.png', bbox_inches='tight')
plt.close()
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('/home/vljchr004/hpc-mini/final/model4_history2.png', bbox_inches='tight')
...
import numpy as np
np.savetxt("/home/vljchr004/hpc-mini/final/model4_results.csv", np.array(model.probs), fmt="%s")

np.savetxt("/home/vljchr004/hpc-mini/final/model4_y_test.csv", np.array(y_test), fmt="%s")

model.save('/home/vljchr004/hpc-mini/final/model4_.h5')
del model
