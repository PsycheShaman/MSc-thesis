...
plt.savefig('/home/vljchr004/hpc-mini/raw_data/model2_history1.png', bbox_inches='tight')
plt.close()
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('/home/vljchr004/hpc-mini/raw_data/model2_history2.png', bbox_inches='tight')

plt.close()

model.save('/home/vljchr004/hpc-mini/raw_data/model2_.h5')
del model
