...
ggplot(dedx_plot[(as.character(dedx_plot$`Particle ID`)=="electron"&dedx_plot$P>=1.5)|(as.character(dedx_plot$`Particle ID`)=="pion"&dedx_plot$P>=2),],aes(P,dEdX))+geom_hex(bins=100)+facet_wrap(~`Particle ID`,labeller = particle_labeler)+
