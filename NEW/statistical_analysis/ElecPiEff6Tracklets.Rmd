...
```{r}
rm(list=ls())
pred <- read.csv("C:/Users/gerhard/Documents/hpc-mini/chamber_gain_corrected/model23_results.csv",header=F)
act <- read.csv("C:/Users/gerhard/Documents/hpc-mini/chamber_gain_corrected/model23_y_test.csv",header=F)
```
