...
model = Sequential()
model.add(Conv2D(32,(6,6),input_shape=(17,24,1),activation="tanh"))
model.add(Dropout(rate=0.05))
model.add(Conv2D(64,(6,6),activation="tanh"))
model.add(Dropout(rate=0.05))
model.add(Conv2D(128,(6,6),activation="tanh"))
...
sgd = tensorflow.keras.optimizers.SGD(lr=0.0001,momentum=0.99,nesterov=True) 
...
plt.savefig('/home/vljchr004/hpc-mini/model21_history1.png', bbox_inches='tight')
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('/home/vljchr004/hpc-mini/model21_history2.png', bbox_inches='tight')

model.probs = model.predict_proba(x_test)

import numpy as np
np.savetxt("/home/vljchr004/hpc-mini/model21_results.csv", np.array(model.probs), fmt="%s")

np.savetxt("/home/vljchr004/hpc-mini/model21_y_test.csv", np.array(y_test), fmt="%s")

model.save('/home/vljchr004/hpc-mini/model21_.h5')  # creates a HDF5 file 'my_model.h5'
del model
